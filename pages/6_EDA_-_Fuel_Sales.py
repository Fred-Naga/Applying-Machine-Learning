...
st.markdown('''
            This section explores county-level fuel sales and its relationship with liquor sales gross profit. While we expect an increase in fuel sales to correlate with foot traffic in counties and their stores, increasing profits, we will also explore how it relates to both city and interstate highway location. 
            ''')
